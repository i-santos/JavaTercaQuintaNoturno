...
public class TarefaDAO {
    ...
    public static ArrayList<Tarefa> buscarTarefas(){ 
        ArrayList<Tarefa> tarefas = new ArrayList();
        
        try (Connection c = Conexao.abrirConexao()) {
            
            PreparedStatement stmt = c.prepareStatement("SELECT * FROM lista_tarefas.tarefa");
    ...
    public static boolean excluir(Tarefa t) {
        boolean sucesso = false;
